...
#define powerout 27
//WS2812灯
#define WS2812_PIN 4  // Arduino输出控制信号引脚
...
#define LED_PIN 33
//创建音乐旋律列表，超级玛丽
int melody[] = { 330, 330, 330, 262, 330, 392, 196, 262, 196, 165 };  //220, 247, 233, 220, 196, 330, 392, 440, 349, 392};
                                                                      //  330, 262, 294, 247, 262, 196, 165, 220, 247, 233, 220, 196, 330, 392, 440, 349, 392, 330, 262, 294 };
// 247, 392, 370, 330, 311, 330, 208, 220, 262, 220, 262, 294, 392, 370, 330, 311, 330, 523, 523, 523,
// 392, 370, 330, 311, 330, 208, 220, 262, 220, 262, 294, 311, 294, 262, 262, 262, 262, 262, 294, 330,
// 262, 220, 196, 262, 262, 262, 262, 294, 330, 262, 262, 262, 262, 294, 330, 262, 220, 196 };
//创建音调持续时间列表
int noteDurations[] = { 8, 4, 4, 8, 4, 2, 2, 3, 3, 3 };  //4, 4, 8, 4, 8, 8, 8, 4, 8, 4};
                                                         // 3, 8, 8, 3, 3, 3, 3, 4, 4, 8, 4, 8, 8, 8, 4, 8, 4, 3, 8, 8 };
// 2, 8, 8, 8, 4, 4, 8, 8, 4, 8, 8, 3, 8, 8, 8, 4, 4, 4, 8, 2,
// 8, 8, 8, 4, 4, 8, 8, 4, 8, 8, 3, 3, 3, 1, 8, 4, 4, 8, 4, 8,
// 4, 8, 2, 8, 4, 4, 8, 4, 1, 8, 4, 4, 8, 4, 8, 4, 8, 2 };
int noteDuration;
//
...
class MyClientCallback : public BLEClientCallbacks {
  ...
  void onDisconnect(BLEClient* pclient) {
    Push_EN = false;
    connected = false;
    pixels.setPixelColor(0, pixels.Color(250, 0, 0));  //注意是从0开始，第一个led对应0
    pixels.show();                                     //刷新
...
void ADC_Control(void) {
  ...
  } else if (RR_X.Equivalence > 120)  //摇下
  {
    if (Running_Speed == 1) {
      BLOCKS_DATA = 49;  //正转低速
      running_flag = 1;
  ...
  } else if (RR_Y.Equivalence < 5)  //摇左
  {
    BLOCKS_DATA = 17;  //左转直到
    running_flag = 1;
  } else if (RR_Y.Equivalence > 195)  //摇右
  {
    BLOCKS_DATA = 18;  //右转直到
    running_flag = 1;
  }
