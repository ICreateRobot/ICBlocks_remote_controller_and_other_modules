...
//        }
        ...
        else if((3730<=ADC_Value[i])&&(ADC_Value[i]<3829))  //记忆模块
        {
            Interface[i]=37;
        }
        else if((3830<=ADC_Value[i])&&(ADC_Value[i]<3929))  //
        {
            //   Interface[i]=38;    ////模块11......
        }
        else  //没有模块
...
void Error_hint()
{
    for(uint8_t i=0; i<8; i++)
    {
        ...
        {
            if((Interface[i+1]!=31)&&(Interface[i+1]!=32)&&(Interface[i+1]!=33)&&(Interface[i+1]!=34)&&(Interface[i+1]!=35)&&(Interface[i+1]!=36))//橙色块
            {
                Programming_Warning=1;
                G_location[i]=i;
            }
    ...
    for(uint8_t j=0; j<location; j++)//判断是否接触
    {
        ...
        if(Interface[7]==37)//有记忆模块
        {
            if((Interface[j]==31)||(Interface[j]==32)||(Interface[j]==33)||(Interface[j]==34)||(Interface[j]==35)||(Interface[j]==36)) //倾斜
            {
                Programming_Error=1;
                NO_Touch=9;
            }
    ...
    else  //编程正常
    {
        ...
        if(Interface[7]==37)
        {
            for(uint8_t k=location+1; k<=6; k++)
            {
                GPIO_SET(k);
            }
        }
        ...
        {
            for(uint8_t k=location+1; k<=7; k++)
            {
                GPIO_SET(k);
            }
        }
